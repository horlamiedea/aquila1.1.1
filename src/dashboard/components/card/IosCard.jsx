...
const IosCard = () => {
  const { currentProject: project_name, reports,
    reportHistory, } = useSelector(
                ...
                <div key={index} className="py-4 px-6 w-full flex justify-between">
                  <div className="w-full flex justify-between items-start">
                    <div className="flex flex-col text-[14px]">
                      <p><strong>File Name:</strong> {iosReport.FILE_NAME}</p>
                      <p><strong>Time Stamp: </strong>{iosReport.TIMESTAMP}</p>
                      <p><strong>Size: </strong>{iosReport.SIZE}</p>
