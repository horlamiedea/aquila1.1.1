...
// import { SET_REPORT_HISTORY, SET_REPORT_HISTORY_ID } from "../../../redux/slice/appState";
    ...
    <div>
      {/* {showModal && (
        <div className="fixed inset-0 flex justify-center items-center z-50">
          ...
          <div className="relative w-[60%] h-auto max-h-[70vh] rounded-xl bg-white shadow-2xl p-4 font-montserrat z-50 overflow-y-scroll">
            <AiOutlineClose
                ...
                <div key={index} className="py-4  w-full flex justify-between">
                  <div className="w-full flex justify-between">
                    <div className="flex flex-col">
                      <p>Time Stamp: {apkReport.TIMESTAMP}</p>
                      <p>Size: {apkReport.SIZE}</p>
                      <p>File Name: {apkReport.FILE_NAME}</p>
                      <p>File Name: {apkReport.id}</p>
                    </div>
                    <div 
