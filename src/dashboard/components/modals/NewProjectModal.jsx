...
import { TOGGLE_OPENMODAL } from "../../../redux/slice/appState";
    ...
    <div className="bg-black shadow-lg shadow-neutral-500/50 z-10 h-screen absolute  w-full flex justify-center items-center backdrop-filter backdrop-blur-sm bg-opacity-50">
      ...
      <AiOutlineClose onClick={() => disPatch(TOGGLE_OPENMODAL())}   className="absolute top-3 right-3 cursor-pointer" />
        <div className="">
          ...
          <p className="text-gold">Project Name</p>
          <form  onSubmit={createProject} className="flex flex-col md:w-1/2">
            ...
            />
            {submitted && !name && <p className="text-red text-xs md:text-sm mb-2">Create a Project Name</p>}
          <button disabled={loading} className="bg-gold pb-1 text-white rounded-md mt-2 ">
